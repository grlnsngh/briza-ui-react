...
export const DarkTheme: Story = {
  render: () => (
    <ThemeProvider defaultMode="dark">
      ...
      >
        <h3 style={{ marginBottom: "24px", color: "#f9fafb" }}>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Input component in dark theme mode. Notice how the background colors transition from dark gray (#374151) at rest to lighter gray (#4b5563) on hover, providing clear visual feedback. All validation states and features work seamlessly in dark mode.",
      },
    },
  },
};
